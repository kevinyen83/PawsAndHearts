    ...
    test('render pets data successfully', async () => {
        mockedFetchPet.mockResolvedValue([
          {
            ...
            color: 'White',
            size: 'Medium',
            image: 'https://media.istockphoto.com/id/1361394182/photo/funny-british-shorthair-cat-portrait-looking-shocked-or-surprised.jpg?b=1&s=612x612&w=0&k=20&c=-niqIUX8Kfiyn50xgUzxxUYX6H2q9BlGc3PX5PVM-iA=',
            location: 'City Park',
            vaccination: 'Yes',
        ...
        await waitFor(() => {
            ...
            itemContainers.forEach((container) => {
              ...
              const itemGender = container.querySelector('[data-testid="item-gender"]');
              ...
              const itemLocation = container.querySelector('[data-testid="item-location"]');
              const itemVaccination = container.querySelector('[data-testid="item-vaccination"]');
