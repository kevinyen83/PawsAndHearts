    ...
    <div className='border-gray-100 shadow-2xl border-4 rounded text-center mt-10 w-[35%] h-[40%] max-w-[1040px]'>
      <div>
        ...
        <div>
          ...
          <button className='mt-8 flex w-full justify-center rounded-md border border-transparent bg-blue-700 hover:bg-blue-800 py-2 px-4 text-sm font-medium text-white shadow-sm' onClick={handlePayment}>
            Donate
          </button>
        </div>
      </div>
